...
FALLBACK_IMAGE_BASE = "https://raw.githubusercontent.com/kevinamartin88/worth-buying-uk/main/assets/x/uk"
...
def build_text(title: str, url: str) -> str:
    text = (
        f"🔎 {title}\n\n"
        "Our latest UK buying guide compares current options, value and practical buying checks.\n\n"
        f"Affiliate 🔗 {url}\n"
